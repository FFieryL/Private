...
import { chat, getColorCodes } from "../util/utils";
...
const ircData = new PogObject("PrivateASF",{color: "&5", fulldisable: false}, "data/irc_data.json");
...
// function connect() {
//     if (manuallyDisabled || isConnectingNow) return;
//     if (myWS && myWS.isOpen()) return;
//     isConnectingNow = true
//     myWS = new WebSocketPASF(WS_URL);
//     myWS.onMessage = (msg) => {
...
//     myWS.onClose = () => {
//         isConnectingNow = false
//         if (!isReconnecting && !manuallyDisabled) {
//             isReconnecting = true;
//             console.log("&cIRC Connection lost. Reconnecting in 5 seconds...");
